...
import { CodeEditorContext, CodeEditorControl } from './CodeEditorControl';
...
> {
  ...
  static getExtensionFromLanguage(language: CodeEditorLanguage) {
    switch (language) {
      case CodeEditorLanguage.shell:
        return 'sh';
      case CodeEditorLanguage.ruby:
        return 'rb';
      case CodeEditorLanguage.perl:
        return 'pl';
      case CodeEditorLanguage.python:
        return 'py';
      case CodeEditorLanguage.mysql:
        return 'sql';
      case CodeEditorLanguage.javascript:
        return 'js';
      case CodeEditorLanguage.typescript:
        return 'ts';
      case CodeEditorLanguage.markdown:
        return 'md';
  ...
  onDropRejected = (rejectedFiles: File[]) => {
    if (rejectedFiles.length > 0) {
      // eslint-disable-next-line no-console
      console.error(t`There was an error accepting that dropped file`); // TODO
    }
  };
