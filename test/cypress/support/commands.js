...
Cypress.Commands.add('logout', {}, () => {
    cy.server();
    cy.route('GET', urljoin(Cypress.env('baseUrl'), Cypress.env('prefix'), '_ui/v1/me/')).as('me');
...
Cypress.Commands.add('login', {}, (username, password) => {
    let loginUrl = urljoin(Cypress.env('baseUrl'), Cypress.env('prefix'), '_ui/v1/auth/login/');
    cy.server();
